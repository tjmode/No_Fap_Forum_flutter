...
import 'package:no_fap_forum/subModules/WhyNoFapPage.dart';

class WhyWeNeed extends StatelessWidget {
  const WhyWeNeed({Key? key}) : super(key: key);
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              image: AssetImage("assets/capCell.jpeg"),
              fit: BoxFit.fill,
            ),
            boxShadow: [
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => const WhyNoFapPage()),
                              );
                            },
                            child: Row(
                              children: [
